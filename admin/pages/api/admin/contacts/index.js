...
import { getSubmission, listSubmissions, updateSubmission } from "@/services/server/submissionsService";
...
export default createSubmissionHandler("contact_submissions", "contacts.read", "contacts.update", "/api/admin/contacts");
