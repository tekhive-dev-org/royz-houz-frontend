...
/**
 * Validates privileged configuration for protected API routes and services.
 * Errors list only missing or invalid variable names; secret values are never
 * logged or included in the error message.
 */
